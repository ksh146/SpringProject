...
<div id="root">
	...
	<section id="container">
		...
		<div class="inputArea">
			...
			<input type="text" id="socksName" name="socksName" />
		</div>
		
		<div class="inputArea">
			<label for="socksPrice">상품가격</label>
			<input type="text" id="socksPrice" name="socksPrice" />
		</div>
		
		<div class="inputArea">
			<label for="socksStock">상품수량</label>
			<input type="text" id="socksStock" name="socksStock" />
		</div>
		
		<div class="inputArea">
			<label for="socksDes">상품소개</label>
			<textarea rows="5" cols="50" id="socksDes" name="socksDes"></textarea>
		</div>
...
$("#socksPrice").keyup(function() {
	numCheck($(this));
});

$("#socksStock").keyup(function() {
	numCheck($(this));
});
