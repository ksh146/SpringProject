		...
		<div id="container_box">
			...
			<section id="content">
				<div class="orderInfo">
					<c:forEach items="${orderView}" var="orderView" varStatus="status">
						...
						<c:if test="${status.first}">
							<p><span>받는사람 </span>${orderView.orderRec}</p>
				...
				<ul class="orderView">
					...
					<li>
						<div class="thumb">
							<img src="${orderView.socksThumbImg}" />
						</div>
						<div class="socksInfo">
							<p>
								<span>상품명 </span>${orderView.socksName}<br>
								<span>개당 가격 </span><fmt:formatNumber pattern="###,###,###" value="${orderView.socksPrice}" /> 원<br>
								<span>구매 수량 </span>${orderView.cartStock} 개<br>
								<span>총액 </span><fmt:formatNumber pattern="###,###,###" value="${orderView.socksPrice * orderView.cartStock}" /> 원<br>
							</p>
						</div>
					</li>
